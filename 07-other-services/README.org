...
Para terminar, *sube una nueva foto de la misma persona* (distinta de las fotos utilizadas anteriormente) y comprueba en los logs que *detecta de qué usuario se trata*:
