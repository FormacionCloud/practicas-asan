...
* Limpieza
Al finalizar, *elimina* el secreto creado en la práctica.

#+begin_quote
[!WARNING]
El parámetro de Systems Manager no tiene gasto asociado. No lo elimines todavía, ya que será utilizado en la práctica de Beanstalk del módulo de Automatización y Despliegue.
#+end_quote
