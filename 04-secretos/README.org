...
A partir de ahora, puedes hacer referencia a él desde nuestros archivos PHP mediante el siguiente código, ajustando la ruta correspondiente si fuera necesario:
#+begin_src php
  <?php
     require './aws.phar';
  ?>
